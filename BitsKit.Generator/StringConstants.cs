...
internal static class StringConstants
{
    ...
    /// </para>
    /// </summary>
    public const string IntegralGetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.Read{{2}}{{3}}({0}, {{5}}, {{6}});";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string ExplicitGetterTemplate = "{{0}} {{1}} => ({1})global::BitsKit.Primitives.BitPrimitives.Read{{2}}{{3}}({0}, {{5}}, {{6}});";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string BooleanGetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.Read{{2}}{{3}}({0}, {{5}}, 1) == 1;";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string BooleanSpanGetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.ReadBit{{3}}({0}, {{5}});";
    ...
    /// </para>
    /// </summary>
    public const string IntegralSetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.Write{{2}}{{3}}({0}, {{5}}, value, {{6}});";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string ExplicitSetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.Write{{2}}{{3}}({0}, {{5}}, ({1})value, {{6}});";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string BooleanSetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.Write{{2}}{{3}}({0}, {{5}}, ({1})(value ? 1 : 0), 1);";
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public const string BooleanSpanSetterTemplate = "{{0}} {{1}} => global::BitsKit.Primitives.BitPrimitives.WriteBit{{3}}({0}, {{5}}, value);";
}
